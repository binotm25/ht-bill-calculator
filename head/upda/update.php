...
<img src="/img/equilizer.gif" class="img-responsive" id="loading">
        ...
        if($query == false){
            echo '<h3 class="text-center text-danger">Whoopsie.... You are too late to update this Report! Ask the Admin!</h3>';
            die();
        }
        ?>
    <h3 class="text-center text-success">Update The Reports</h3>
    <div id="page-wrapper">
                ...
                <?php
                  ...
                  while($row = $query->fetch_assoc()){
                    ...
                    '<tr>
                        ...
                        <td>'.$row["name"].'</td>
                        <td>
                            <input type="number" min="0" max="730" maxlength="3" id="'.$row["id"].'" class="form-control" placeholder="'.$row[$res->column].'" />
                        </td>
                    </tr>'; $count++;
                    }
                ?>
